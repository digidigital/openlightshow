...
⚠️ Follow the instructions in next section or **just copy the AI-prompt** from the [Project Website](https://openlightshow.digidigital.de) in order to create your own effects!
